...
public partial class Label
{
	...
	public Label() : this(inherited: true) => Android = new Android.Widget.Button(Platform.Context);

	public Label(Context context) : this(inherited: true) => Android = new Android.Widget.Button(context);

#pragma warning disable CS8618
	public Label(bool inherited)
